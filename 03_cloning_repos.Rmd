...
```{r, fig.align='center', echo = FALSE, fig.alt= "This shows how to git clone"}
ottrpal::include_slide("https://docs.google.com/presentation/d/1bhTNTBhdXa0e0BXRZmQoHY6zTKGqgrr4wwYS8-v7ob8/edit#slide=id.g36809c5e39_0_15")
```
