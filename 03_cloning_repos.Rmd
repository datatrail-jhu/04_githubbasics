...
### Step 3: Use the RStudio interface to clone the repository
...
It will ask you to `? Enter password or token`. Copy your PAT and paste it into the command window



7. Add your username and email to the github credentials by running this command (but replace the example username and email with what corresponds to your GitHub account).
use_git_config(user.name = "Jane", user.email = "jane@example.org")
8. Check that everything has been set correctly by running:
git_sitrep()
...
Now you should be able to use GitHub from RStudioCloud
